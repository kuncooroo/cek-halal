    ...
    <div class="max-w-4xl mx-auto">
        ...
        <x-card>
            <div class="px-8 py-6 border-b border-gray-100 bg-gray-50 dark:bg-slate-700/50 dark:border-slate-700">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Form Tambah Produk</h2>
                <p class="text-sm text-gray-600 mt-1 dark:text-gray-400">Lengkapi detail produk di bawah ini.</p>
            </div>

            <div class="p-8">
                <form action="{{ route('admin.produk.store') }}" method="POST" novalidate>
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2 dark:text-gray-300">Nama Produk
                            ...
                            <div>
                                <label class="block text-sm font-bold text-gray-700 mb-2 dark:text-gray-300">Nama Produsen
                                    <span class="text-red-500">*</span></label>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2 dark:text-gray-300">Tanggal
                                        Terbit<span class="text-red-500">*</span></label></label>
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 mb-2 dark:text-gray-300">Tanggal
                                        Kadaluarsa<span class="text-red-500">*</span></label></label>
