...
@section('content')
    <div class="flex flex-col xl:flex-row gap-8 max-w-7xl mx-auto">
        ...
        <div
            class="w-full xl:w-72 flex-shrink-0 space-y-8 border-l border-gray-100 dark:border-slate-700 pl-0 xl:pl-8 mt-4 xl:mt-0">

            <div>
                <h3 class="text-sm font-bold text-gray-900 dark:text-white mb-4">Notifications</h3>
                <div class="space-y-6">
                    <div class="flex items-start space-x-3">
                        <div
                            class="w-8 h-8 rounded-lg bg-blue-50 dark:bg-slate-700 flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                            <p class="text-xs font-medium text-gray-900 dark:text-gray-200">You fixed a bug.</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500">Just now</p>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div
                        ...
                        <div>
                            <p class="text-xs font-medium text-gray-900 dark:text-gray-200">New user registered.</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500">59 minutes ago</p>
                        </div>
                    </div>
                    <div class="flex items-start space-x-3">
                        <div
                        ...
                        <div>
                            <p class="text-xs font-medium text-gray-900 dark:text-gray-200">Andi Lane subscribed.</p>
                            <p class="text-[10px] text-gray-400 dark:text-gray-500">Today, 11:59 AM</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <h3 class="text-sm font-bold text-gray-900 dark:text-white mb-4">Activities</h3>
                <div class="relative pl-2 border-l border-gray-200 dark:border-slate-700 space-y-6">
                    <div class="relative pl-4">
                        <div
                            class="absolute -left-1.5 top-1 w-3 h-3 bg-red-400 rounded-full border-2 border-white dark:border-slate-800">
                        </div>
                        <p class="text-xs font-medium text-gray-800 dark:text-gray-300">Changed the style.</p>
                        <p class="text-[10px] text-gray-400 dark:text-gray-500">Just now</p>
                    </div>
                    <div class="relative pl-4">
                        <div
                            class="absolute -left-1.5 top-1 w-3 h-3 bg-yellow-400 rounded-full border-2 border-white dark:border-slate-800">
                        </div>
                        <p class="text-xs font-medium text-gray-800 dark:text-gray-300">Release a new version.</p>
                        <p class="text-[10px] text-gray-400 dark:text-gray-500">59 minutes ago</p>
                    </div>
                    <div class="relative pl-4">
                        <div
                            class="absolute -left-1.5 top-1 w-3 h-3 bg-blue-400 rounded-full border-2 border-white dark:border-slate-800">
                        </div>
                        <p class="text-xs font-medium text-gray-800 dark:text-gray-300">Submitted a bug.</p>
                        <p class="text-[10px] text-gray-400 dark:text-gray-500">12 hours ago</p>
                    </div>
                    <div class="relative pl-4">
                        <div
                            class="absolute -left-1.5 top-1 w-3 h-3 bg-green-400 rounded-full border-2 border-white dark:border-slate-800">
                        </div>
                        <p class="text-xs font-medium text-gray-800 dark:text-gray-300">Modified A data in Page X.</p>
                        <p class="text-[10px] text-gray-400 dark:text-gray-500">Today, 11:59 AM</p>
                    </div>
                </div>
            </div>
            ...
            <div>
                <h3 class="text-sm font-bold text-gray-900 dark:text-white mb-4">Contacts</h3>
                <div class="space-y-4">
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 rounded-full bg-gray-200 dark:bg-slate-700 overflow-hidden">
                            <img src="https://ui-avatars.com/api/?name=Natali+Craig&background=random" alt="User">
                        </div>
                        <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Natali Craig</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 rounded-full bg-gray-200 dark:bg-slate-700 overflow-hidden">
                            <img src="https://ui-avatars.com/api/?name=Drew+Cano&background=random" alt="User">
                        </div>
                        <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Drew Cano</span>
                    </div>
                    <div class="flex items-center space-x-3">
                        <div class="w-8 h-8 rounded-full bg-gray-200 dark:bg-slate-700 overflow-hidden">
                            <img src="https://ui-avatars.com/api/?name=Andi+Lane&background=random" alt="User">
                        </div>
                        <span class="text-xs font-medium text-gray-700 dark:text-gray-300">Andi Lane</span>
                    </div>
                </div>
            </div>
