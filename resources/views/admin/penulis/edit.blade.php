    ...
    <div class="max-w-4xl mx-auto">
        <x-card>
            <div class="px-8 py-6 border-b border-gray-100 bg-gray-50 dark:bg-slate-700/50 dark:border-slate-700">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit Penulis</h2>
                <p class="text-sm text-gray-600 mt-1 dark:text-gray-400">Perbarui data penulis di bawah ini.</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="email" value="{{ old('email', $penulis->email) }}"
                                    class="block w-full rounded-lg border-gray-400 bg-gray-50 px-4 py-3 text-gray-900 focus:bg-white focus:border-black focus:ring-black sm:text-sm shadow-sm transition-all duration-200 
                                    dark:bg-slate-900 dark:border-slate-600 dark:text-white dark:focus:bg-slate-800 dark:focus:border-slate-500 dark:focus:ring-slate-500">
                                @error('email')
                                    <p class="mt-1 text-xs text-red-500">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                @if ($penulis->foto)
                                    <div class="mb-3 flex items-center gap-3">
                                        <img src="{{ asset('storage/' . $penulis->foto) }}" alt="Current Foto"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="aktif"
                                        ...
                                        dark:bg-slate-900 dark:border-slate-600 dark:text-white dark:focus:bg-slate-800 dark:focus:border-slate-500 dark:focus:ring-slate-500">
                                        <option value="1" {{ old('aktif', $penulis->aktif) == '1' ? 'selected' : '' }}>
                                            Aktif</option>
                                        <option value="0" {{ old('aktif', $penulis->aktif) == '0' ? 'selected' : '' }}>
                                            Non-Aktif</option>
                                    </select>
                                    <div
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="bio" rows="4"
                                class="block w-full rounded-lg border-gray-400 bg-gray-50 px-4 py-3 text-gray-900 focus:bg-white focus:border-black focus:ring-black sm:text-sm shadow-sm transition-all duration-200 
                                dark:bg-slate-900 dark:border-slate-600 dark:text-white dark:focus:bg-slate-800 dark:focus:border-slate-500 dark:focus:ring-slate-500">{{ old('bio', $penulis->bio) }}</textarea>
                        </div>
