    ...
    <div class="max-w-4xl mx-auto">
        ...
        <x-card>
            <div class="px-8 py-6 border-b border-gray-100 bg-gray-50 dark:bg-slate-700/50 dark:border-slate-700">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Edit FAQ</h2>
                <p class="text-sm text-gray-600 mt-1 dark:text-gray-400">Perbarui konten pertanyaan dan jawaban.</p>
            </div>

            <div class="p-8">
                <form action="{{ route('admin.faq.update', $faq->id) }}" method="POST" novalidate>
                    @csrf
                    @method('PUT')
